...
> ## 2019
+ [**Ping Zeng**](https://github.com/biostatpzeng)<sup>#</sup> and Xiang Zhou<sup>#</sup> (2019). Causal Association between Birth Weight and Adult Diseases: Evidence from a Mendelian Randomisation Analysis. **Frontiers in Genetics** (in press). [doi: 10.3389/fgene.2019.00618](https://www.frontiersin.org/articles/10.3389/fgene.2019.00618/abstract).
