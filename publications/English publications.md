...
> ## 2019
+ Xinghao Yu![#f03c15](https://placehold.it/15/f03c15/000000?text=+), Lishun Xiao, [**Ping Zeng**](https://github.com/biostatpzeng)<sup>#</sup> and Shuiping Huang<sup>#</sup> (2019). Jackknife model averaging prediction methods for complex phenotypes with gene expression levels by integrating external pathway information. **Computational and Mathematical Methods in Medicine** (in press; I am almost sure that this journal can belong to the so called YEJI QIKANs). [biorxiv](https://www.biorxiv.org/content/early/2018/10/19/447706). [Software](https://github.com/biostatpzeng/JMAP)
