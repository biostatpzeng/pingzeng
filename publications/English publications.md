...
> ## 2025
+ Wenying Chen<sup>$</sup>, Yuxin Liu<sup>$</sup>, Shuo Zhang<sup>$</sup>, Zhou Jiang<sup>$</sup>, Ting Wang, Shuiping Huang<sup>#</sup> and [**Ping Zeng**](https://github.com/biostatpzeng)<sup>#</sup> (2025). Transfer learning prediction of early exposures and genetic risk score on adult obesity in two minority cohorts. **Prevention Science**, in press.
...
+ Yuxin Liu$, Wenyan Hou$, Tongyu Gao, Yu Yan, Ting Wang, Chu Zheng and Ping Zeng# (2025). Influences and roles of polygenic risk score in the development and age at onset of 32 complex diseases. **Journal of Global Health**, in press.
