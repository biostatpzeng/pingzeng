...
> ## Technical Reports
----------------------------------------------------------------------------------------------------------------------------------------
+ [**Ping Zeng**](https://github.com/biostatpzeng)<sup>#</sup> (2020). Statistical approaches for transcriptome wide association studies with expression measurements imputed from multiple genetic prediction models.
